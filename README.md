...
- `/game21` - Сыграть в 21 Очко PvP (игроки друг против друга, 2-6 игроков)
- `/blackjack` - Сыграть в Блекджек (против дилера, 2-6 игроков)
...
2. Выбери режим игры:
   ...
   - `/blackjack` - Против дилера (классический блекджек)
3. Нажми кнопку "🎮 Играть"
4. Дождись других игроков (минимум 2)
5. Начни игру и побеждай!

**Два режима игры:**
- **`/game21`** - Игроки играют друг против друга без дилера. Побеждает тот, у кого больше очков (≤21)
- **`/blackjack`** - Классический блекджек. Все игроки играют против дилера
